...
export const containers: Component[] = [
  ...
  },
  {
    ...
    name: 'DSL',
    type: 'container',
    description: 'Builder functions and checker factories',
    technology: { name: 'TypeScript' },
    boundaryId: 'BND-002',
    layerId: 'LAYER-003',
    relations: [
      { type: 'implements', target: 'FR-104', description: 'Implements model definition requirement' },
      { type: 'implements', target: 'FR-107', description: 'Implements core-provided model factories (lint, exporter, schema, checker)' },
      { type: 'implements', target: 'FR-703', description: 'Implements edge type-specific relation schemas' },
      { type: 'implements', target: 'FR-1000', description: 'Implements external checker validation logic' },
      { type: 'implements', target: 'FR-1001', description: 'Implements OpenAPI YAML/JSON parsing' },
      { type: 'implements', target: 'FR-1002', description: 'Implements OpenAPI spec ID verification' },
      { type: 'implements', target: 'FR-1003', description: 'Implements OpenAPI missing spec ID warning' },
      { type: 'implements', target: 'FR-1004', description: 'Implements OpenAPI method check' },
      { type: 'implements', target: 'FR-1005', description: 'Implements OpenAPI parameter/response check' },
      { type: 'implements', target: 'FR-1006', description: 'Implements OpenAPI mismatch warnings' },
      { type: 'implements', target: 'FR-1007', description: 'Implements OpenAPI file not found error' },
      { type: 'implements', target: 'FR-1008', description: 'Implements OpenAPI parse failure error' },
      { type: 'implements', target: 'FR-1009', description: 'Implements SQL DDL parsing' },
      { type: 'implements', target: 'FR-1010', description: 'Implements SQL table existence check' },
      { type: 'implements', target: 'FR-1011', description: 'Implements SQL column existence check' },
      { type: 'implements', target: 'FR-1012', description: 'Implements SQL type consistency check' },
      { type: 'implements', target: 'FR-1013', description: 'Implements SQL checker warnings' },
      { type: 'implements', target: 'FR-1014', description: 'Implements SQL file not found error' },
      { type: 'implements', target: 'FR-1015', description: 'Implements SQL parse failure graceful degradation' },
      { type: 'implements', target: 'FR-1016', description: 'Implements checker pattern consistency' },
      { type: 'implements', target: 'FR-1017', description: 'Implements source path fallback' },
      { type: 'implements', target: 'FR-1018', description: 'Implements minimal new dependencies constraint' },
  ...
  },
  {
    ...
    relations: [
      ...
      { type: 'implements', target: 'FR-702', description: 'Implements verifiedBy/verifies relation types' },
  ...
  },
  {
    ...
    relations: [
      ...
      { type: 'implements', target: 'FR-605', description: 'Implements model-integrated check architecture' },
      ...
      { type: 'implements', target: 'FR-1019', description: 'Implements checker documentation accuracy' },
  ...
  },
  {
    ...
    relations: [
      ...
      { type: 'implements', target: 'FR-201', description: 'Implements external SSOT path configuration' },
    ],
  },
  {
    id: 'CONT-008',
    name: 'Scaffold',
    type: 'container',
    description: 'Mermaid flowchart-based project scaffold generator',
    technology: { name: 'TypeScript' },
    boundaryId: 'BND-002',
    layerId: 'LAYER-002',
    relations: [
      { type: 'implements', target: 'FR-106', description: 'Implements artifact class-based scaffold generation from mermaid flowcharts' },
      { type: 'dependsOn', target: 'CONT-002', description: 'Depends on type definitions for generated models' },
    ],
  },
];
...
export const relations: ArchitectureRelation[] = [
  ...
  { id: 'REL-A009', from: 'CONT-001', to: 'CONT-008', label: 'calls', technology: 'function call' },
  // External relations
