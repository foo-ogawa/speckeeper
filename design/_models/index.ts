...
// Model classes (base classes kept for backward compatibility)
export { RequirementModel, FunctionalRequirementModel, NonFunctionalRequirementModel, ConstraintModel } from './requirement.ts';
export { UseCaseModel, ActorModel } from './usecase.ts';
export { TermModel } from './term.ts';
export { EntityModel } from './concept-model.ts';
export { ComponentModel, ActorComponentModel, ExternalSystemModel, ContainerModel, BoundaryModel, LayerModel, RelationModel } from './architecture.ts';
...
// Only concrete subclasses with matching idPrefix are registered.
import { FunctionalRequirementModel, NonFunctionalRequirementModel, ConstraintModel } from './requirement.ts';
import { UseCaseModel, ActorModel } from './usecase.ts';
import { TermModel } from './term.ts';
import { EntityModel } from './concept-model.ts';
import { ActorComponentModel, ExternalSystemModel, ContainerModel, BoundaryModel, LayerModel, RelationModel } from './architecture.ts';
